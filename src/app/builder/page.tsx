...
// Extend window to include our temporary website storage
declare global {
  interface Window {
...
export default function BuilderPage() {
  ...
  // Store website in global when it changes
  useEffect(() => {
    if (website && typeof window !== "undefined") {
      window.__TEMP_WEBSITE__ = website;
    }
  }, [website]);
  ...
  const handleGenerate = async () => {
    ...
    try {
      ...
      // Store in global for preview pages
      if (typeof window !== "undefined") {
        window.__TEMP_WEBSITE__ = data;
      }
    } catch (err: any) {
          ...
          >
            ...
            <div>
              ...
              {website.pages.map((page) => {
                const pageSlug = page.slug.startsWith("/") 
                  ? page.slug.slice(1) 
                  : page.slug;
